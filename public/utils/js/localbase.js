  ...
  })(
    {
          ...
          Object.defineProperty(n, "__esModule", { value: !0 }),
            (n.default = function () {
              for (var t = 0; t < this.userErrors.length; t++)
                r.default.error.call(this, this.userErrors[t]);
              o.default.call(this);
            });
          var r = i(t(18)),
            o = i(t(3));
                    ...
                    u.lf[f]
                      ...
                      .then(function () {
                        n(
                          r.default.call(
                            u,
                            'Document added to "'.concat(f, '" collection:'),
                            { key: c, data: t }
                          )
                        );
                      })
                      .catch(function (t) {
                        i(
                          o.default.call(
                            u,
                            "Could not add Document to ".concat(
                              f,
                              " collection."
                            )
                          )
          ...
          Object.defineProperty(n, "__esModule", { value: !0 }),
            (n.default = function () {
              ...
              return new Promise(function (e, n) {
                if (
                  ((t.deleteDatabase = function () {
                    var n = t.dbName;
                    indexedDB.deleteDatabase(n),
                      e(
                        u.default.call(t, 'Database "'.concat(n, '" deleted.'))
                      );
                  }),
                  (t.deleteCollection = function () {
                    ...
                    (t.addToDeleteCollectionQueue = function (e) {
                      t.deleteCollectionQueue.queue.push(e),
                        t.runDeleteCollectionQueue();
                    }),
                      (t.runDeleteCollectionQueue = function () {
                        0 == t.deleteCollectionQueue.running &&
                          ((t.deleteCollectionQueue.running = !0),
                          t.deleteNextCollectionFromQueue());
                      }),
                      (t.deleteNextCollectionFromQueue = function () {
                        if (t.deleteCollectionQueue.queue.length) {
                          var o = t.deleteCollectionQueue.queue[0];
                          t.deleteCollectionQueue.queue.shift(),
                            t.lf[o]
                              .dropInstance({ name: r, storeName: o })
                              .then(function () {
                                t.deleteNextCollectionFromQueue(),
                                  e(
                                    u.default.call(
                                      t,
                                      'Collection "'.concat(o, '" deleted.')
                                    )
                                  );
                              })
                              .catch(function (e) {
                  ...
                  (t.deleteDocument = function () {
                    ...
                    return (
                      (t.deleteDocumentByCriteria = function () {
                        var i = [];
                        t.lf[f]
                            ...
                            i.length ||
                              n(
                                a.default.call(
                                  ...
                                  'No Documents found in "'
                                    .concat(f, '" Collection with criteria ')
                                    .concat(
                                      JSON.stringify(c),
                              ...
                              i.length > 1 &&
                                o.default.warn.call(
                                  t,
                                  "Multiple documents ("
                                    .concat(i.length, ") with ")
                                    .concat(JSON.stringify(c), " found.")
                                );
                          })
                          .then(function () {
              ...
              if (
                ((this.getCollection = function () {
                  ...
                  return t.lf[n]
                    ...
                    .then(function () {
                      ...
                      return (
                        r &&
                          ((c += ', ordered by "'.concat(r, '"')),
                          e.keys
                            ? f.sort(function (t, e) {
                                return t.data[r]
                                  .toString()
                                  .localeCompare(e.data[r].toString());
                              })
                            : f.sort(function (t, e) {
                                return t[r]
                                  .toString()
                                  .localeCompare(e[r].toString());
                              })),
                        "desc" == u && ((c += " (descending)"), f.reverse()),
                        a &&
                          ((c += ", limited to ".concat(a)),
                          (f = f.splice(0, a))),
                        (c += ":"),
                        o.default.log.call(t, c, f),
                        i.default.call(t),
                        f
                      );
                    });
                ...
                (this.getDocument = function () {
                  var e = t.collectionName,
                    ...
                    a = {};
                  return (
                    (t.getDocumentByCriteria = function () {
                      return t.lf[e]
                        .iterate(function (t, e) {
                        ...
                        .then(function () {
                          ...
                          o.default.error.call(
                            t,
                            'Could not find Document in "'
                              .concat(e, '" collection with criteria: ')
                    ...
                    "object" == c(n)
                      ? t.getDocumentByCriteria()
                      : t.getDocumentByKey()
                  );
                }),
                "object" != c(e) || e instanceof Array != 0
                  ? this.userErrors.push(
                  ...
                  : e.hasOwnProperty("keys")
                  ? "boolean" != typeof e.keys &&
                    this.userErrors.push(
          ...
          Object.defineProperty(n, "__esModule", { value: !0 }),
            (n.default = function (t) {
              ...
              return new Promise(function (s, l) {
                if (
                  ((e.setDocumentByCriteria = function () {
                    var a = [];
                    e.lf[n]
                      .iterate(function (e, n) {
                        (0, o.default)(e, f) &&
                          a.push({ key: n, newDocument: t });
                      })
                      .then(function () {
                        a.length ||
                          l(
                            u.default.call(
                              e,
                              "No Documents found in "
                                .concat(n, " Collection with criteria ")
                              ...
                              o === a.length - 1 &&
                                s(
                                  i.default.call(
                                    e,
                                    ""
                                      .concat(a.length, " Document")
                                      .concat(a.length > 1 ? "s" : "", ' in "')
                                      .concat(n, '" collection with ')
                                      .concat(JSON.stringify(f), " set to:"),
                                    t
                                  )
                                );
                            })
                      ...
                      .catch(function (t) {
                        l(
                          u.default.call(
                            ...
                            'Document in "'
                              .concat(n, '" collection with key ')
                              .concat(JSON.stringify(f), " could not be set.")
                          )
                        );
                      });
                  }),
                  t
                    ? ("object" == c(t) && t instanceof Array == 0) ||
                      e.userErrors.push(
            ...
            (n.default = function (t) {
              ...
              return new Promise(function (l, h) {
                (e.updateDocumentByCriteria = function () {
                      ...
                      f.length ||
                        ...
                        f.length > 1 &&
                          r.default.warn.call(
                            e,
                            "Multiple documents ("
                              .concat(f.length, ") with ")
                              .concat(JSON.stringify(c), " found for updating.")
                          );
                    })
                    .then(function () {
                            ...
                            o === f.length - 1 &&
                              l(
                                u.default.call(
                                  e,
                                  ""
                                    .concat(f.length, " Document")
                                    .concat(f.length > 1 ? "s" : "", ' in "')
                                    .concat(n, '" collection with ')
                                    .concat(
                                      JSON.stringify(c),
                                      " updated with:"
                        ...
                        (r = (0, i.default)(o, t)),
                          ...
                          l(
                            u.default.call(
                              ...
                              'Document in "'
                                .concat(n, '" collection with key ')
                                .concat(JSON.stringify(c), " updated to:"),
                              r
                            )
                          );
                      })
                  ...
                  t
                    ? ("object" == s(t) && t instanceof Array == 0) ||
                      e.userErrors.push(
            ...
            (n.default = function (t) {
              return (
                t
                  ...
                  : this.userErrors.push(
                      "No integer specified in limit() method."
                    ),
                this
              );
            }),
      ...
      14: [
        function (t, e, n) {
          ...
          Object.defineProperty(n, "__esModule", { value: !0 }),
            (n.default = function (t) {
              if (t) {
                ...
                return (
                  t in this.lf ||
                    (this.lf[t] = o.default.createInstance({
          ...
          var r,
            o = (r = t(20)) && r.__esModule ? r : { default: r };
          e.exports = n.default;
        },
        { 20: 20 },
      ],
        ...
        function (t, e, n) {
          ...
          (n.default = function t(e) {
            !(function (t, e) {
              ...
              (this.config = { debug: !0 }),
              (this.userErrors = []),
              (this.collection = r.default.bind(this)),
              (this.doc = o.default.bind(this)),
              (this.orderBy = i.default.bind(this)),
              (this.limit = u.default.bind(this)),
              (this.get = a.default.bind(this)),
              (this.add = f.default.bind(this)),
              (this.update = c.default.bind(this)),
              (this.set = s.default.bind(this)),
                      ...
                      (e.exports = c),
                        ...
                        (i.resolve = function (t, e) {
                          ...
                          if (r) d(t, r);
                            ...
                            for (var o = -1, u = t.queue.length; ++o < u; )
                        ...
                        (c.race = function (t) {
                          ...
                          for (var r, u = -1, a = new this(o); ++u < e; )
                            (r = t[u]),
                              this.resolve(r).then(
                                function (t) {
                                  n || ((n = !0), i.resolve(a, t));
                    ...
                    function (t, e, n) {
                            ...
                            return u
                              ...
                              .then(function () {
                                if (
                                  ...
                                  return (
                                    t.db && (t.version = t.db.version + 1), b(t)
                                  );
                              })
                              .then(function () {
                                return (function (t) {
                      ...
                      var N = {
                          ...
                          _initStorage: function (t) {
                            ...
                            o ||
                              ...
                              o.forages.push(e),
                              e._initReady ||
                                ((e._initReady = e.ready), (e.ready = E));
                            var i = [];
                            function a() {
                              return u.resolve();
                            }
                            ...
                            return u
                              ...
                              .then(function (t) {
                                return (
                                  (n.db = t),
                                  w(n, e._defaultConfig.version) ? b(n) : t
                                );
                              })
                              .then(function (t) {
                          ...
                          dropInstance: function (t, e) {
                            ...
                            if (
                              ...
                              n = t.storeName
                                ? i.then(function (e) {
                                    if (
                                      e.objectStoreNames.contains(t.storeName)
                                    ) {
                                      var n = e.version + 1;
                                      y(t);
                                      var r = h[t.name],
                          ...
                          if (
                            ...
                            t &&
                              ("[object ArrayBuffer]" === n ||
                                (t.buffer &&
                                  "[object ArrayBuffer]" === j.call(t.buffer))))
                          ) {
                            var r,
                              o = "__lfsc__:";
                              ...
                              return new u(function (o, i) {
                                ...
                                u.serializer.serialize(e, function (e, r) {
                                  if (r) i(r);
                                    ...
                                    try {
                                      localStorage.setItem(u.keyPrefix + t, e),
                                        o(n);
                                    } catch (a) {
                      ...
                      var G = new ((function () {
                        function t(e) {
                          ...
                          (this._defaultConfig = X({}, V)),
                            (this._config = X({}, this._defaultConfig, e)),
                            ...
                            return (
                              (this._driverSet = c
                                ...
                                .catch(function () {
                                  ...
                                  return (
                                    (r._driverSet = u.reject(t)), r._driverSet
                                  );
                                })),
                              f(this._driverSet, e, n),
                              this._driverSet
                            );
                          }),
          ...
          (n.byteLength = function (t) {
            ...
            (n.toByteArray = function (t) {
              ...
              return (
                2 === a &&
                  ((e =
                    (o[t.charCodeAt(n)] << 2) | (o[t.charCodeAt(n + 1)] >> 4)),
                  (f[s++] = 255 & e)),
                1 === a &&
                  ((e =
                    (o[t.charCodeAt(n)] << 10) |
            ...
            (n.fromByteArray = function (t) {
              for (
                var e, n = t.length, o = n % 3, i = [], u = 0, a = n - o;
                u < a;
                u += 16383
              )
      ...
      28: [
        function (t, e, n) {
          (function (e) {
            ...
            function u(t, n, r) {
                  ...
                  return (
                    ((o =
                      void 0 === n && void 0 === r
                        ...
                        : void 0 === r
                        ? new Uint8Array(t, n)
                        : new Uint8Array(t, n, r)).__proto__ = e.prototype),
                    o
                  );
                })(t, n, r);
              if ("number" == typeof t)
              ...
              var u = (function (t) {
                ...
                return void 0 !== t.length
                  ? "number" != typeof t.length || L(t.length)
                    ? i(0)
                    : c(t)
            ...
            function c(t) {
              for (
                var e = t.length < 0 ? 0 : 0 | s(t.length), n = i(e), r = 0;
                r < e;
                r += 1
              )
                n[r] = 255 & t[r];
            ...
            function d(t, n, r, o, i) {
              ...
              if (("string" == typeof n && (n = e.from(n, o)), e.isBuffer(n)))
                return 0 === n.length ? -1 : y(t, n, r, o, i);
              if ("number" == typeof n)
                return (
                  (n &= 255),
            ...
            (n.kMaxLength = 2147483647),
              ...
              (e.compare = function (t, n) {
                if (
                  ...
                  U(n, Uint8Array) && (n = e.from(n, n.offset, n.byteLength)),
                ...
                if (t === n) return 0;
                for (
                  var r = t.length, o = n.length, i = 0, u = Math.min(r, o);
                  i < u;
                  ++i
                )
                  if (t[i] !== n[i]) {
              ...
              (e.concat = function (t, n) {
                ...
                for (r = 0; r < t.length; ++r) {
                  var u = t[r];
                  if ((U(u, Uint8Array) && (u = e.from(u)), !e.isBuffer(u)))
                    throw new TypeError(
                      '"list" argument must be an Array of Buffers'
                    );
            ...
            function B(t, e, n) {
              ...
              for (var i = "", u = e; u < n; ++u)
                i += (r = t[u]) < 16 ? "0" + r.toString(16) : r.toString(16);
              return i;
            }
            function C(t, e, n) {
                ...
                e = Math.abs(e),
                  isNaN(e) || e === 1 / 0
                    ...
                    : ((u = Math.floor(Math.log(e) / Math.LN2)),
                      ...
                      (e += u + l >= 1 ? h / f : h * Math.pow(2, 1 - l)) * f >=
                        2 && (u++, (f /= 2)),
                      u + l >= s
                        ? ((a = 0), (u = s))
                        : u + l >= 1
                        ...
                        : ((a = e * Math.pow(2, l - 1) * Math.pow(2, o)),
                          (u = 0)));
                o >= 8;
                t[n + d] = 255 & a, d += y, a /= 256, o -= 8
              );
              for (
                u = (u << o) | a, c += o;
                c > 0;
                t[n + d] = 255 & u, d += y, u /= 256, c -= 8
              );
              t[n + d - y] |= 128 * p;
            });
        },
